# import requests : It is used to send HTTP requests to the Strava API.
import requests
...
ACCESS_TOKEN = 'a78b2100ceae356094fbaa231b7d9c4d90590b80' 
ACTIVITIES_URL = 'https://www.strava.com/api/v3/athlete/activities'

# Route to initiate the authorization process and fucntion to handle authorization callback
@app.route('/')
def authorize():
